...
const Details = ({ species }: Props) => (
    <List>
        <Typography sx={{ color: 'red' }}>YOYOYOYOYYO</Typography>
        <ListItem>
        ...
        {species?.species_extra.length ?? 0 > 0 ? (
            <>
        ...
        <ListItem>
            ...
            {species?.species_common_names.length ?? 0 > 0 ? (
                <List>
        ...
        {species?.species_synonyms.length ?? 0 > 0 ? (
            <List>
